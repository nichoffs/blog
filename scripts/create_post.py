...
def create_post(title, filename, draft, leet=False):
...
Lorem ipsum dolor sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
    ...
    """
    with open(("leetcode/" if leet else "posts/")+ filename + ".md", 'w') as f:
        f.write(header)
...
if __name__ == "__main__":
    ...
    argparser.add_argument("-l", "--leet", help="Is this a post or a leetcode?", action="store_true")

    args = argparser.parse_args()

    draft = "true" if args.draft else "false"
    
    create_post(args.title, args.filename, draft, args.leet)
